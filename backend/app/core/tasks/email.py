...
from backend.app.core.emails.config import fast_mail
...
def send_email_task(self, *, recipients: list[str], subject: str, html_content: str, plain_content: str) -> bool:
    try:
        ...
        logger.info(f"Email sent to {recipients} with subject '{subject}' successfully.")
        return True
