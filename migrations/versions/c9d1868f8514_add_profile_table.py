...
def upgrade() -> None:
    ...
    sa.Column('marital_status', sa.Enum('Single', 'Married', 'Divorced', 'Widowed', name='maritalstatusschema'), nullable=False),
    sa.Column('means_of_identification', sa.Enum('Passport', 'NationalID', 'DriverLicense', name='identificationtypeschema'), nullable=False),
    ...
    sa.Column('employment_status', sa.Enum('Employed', 'SelfEmployed', 'Unemployed', 'Student', 'Retired', name='employmentstatusschema'), nullable=False),
