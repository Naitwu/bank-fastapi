...
Revision ID: 7e1799408eb1
Revises: 
Create Date: 2025-11-12 18:22:21.872659
...
def upgrade() -> None:
    ...
    sa.Column('security_question', sa.Enum('FIRST_PET', 'BIRTH_CITY', 'ELEMENTARY_SCHOOL', 'FAVORITE_BOOK', 'CHILDHOOD_FRIEND', 'FAVORITE_FOOD', name='securityquestionsschema'), nullable=False),
    sa.Column('security_answer', sqlmodel.sql.sqltypes.AutoString(length=50), nullable=False),
    sa.Column('account_status', sa.Enum('ACTIVE', 'INACTIVE', 'LOCKED', 'PENDING', name='accountstatusschema'), nullable=False),
    sa.Column('role', sa.Enum('CUSTOMER', 'TELLER', 'ACCOUNT_EXECUTIVE', 'BRANCH_MANAGER', 'ADMIN', 'SUPER_ADMIN', name='rolecoiceschema'), nullable=False),
