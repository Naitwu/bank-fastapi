...
Revision ID: e28141b61c0b
Revises: f73cadda1788
Create Date: 2025-12-01 07:35:21.650164
...
revision: str = 'e28141b61c0b'
down_revision: Union[str, None] = 'f73cadda1788'
...
def upgrade() -> None:
    ...
    sa.Column('transaction_type', sa.Enum('Deposit', 'Withdrawal', 'Transfer', 'Reversal', 'Fee_Charge', 'Loan_Disbursement', 'Loan_Repayment', 'Interest_Credited', name='transactiontypeenum'), nullable=False),
