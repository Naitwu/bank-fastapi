...
Revision ID: 718123759fcb
Revises: c044166b6db7
Create Date: 2025-12-01 04:00:55.738868
...
revision: str = '718123759fcb'
down_revision: Union[str, None] = 'c044166b6db7'
...
def upgrade() -> None:
    ...
    sa.Column('currency', sa.Enum('USD', 'EUR', 'GBP', 'TWD', 'JPY', name='accountcurrencyenum'), nullable=False),
