...
Revision ID: e37880082002
Revises: 824474ab301f
Create Date: 2025-12-05 09:01:36.970196
...
revision: str = 'e37880082002'
down_revision: Union[str, None] = '824474ab301f'
...
def upgrade() -> None:
    ...
    sa.Column('currency', sa.Enum('USD', 'EUR', 'GBP', 'JPY', 'TWD', name='virtualcardcurrencyenum'), nullable=False),
    ...
    sa.Column('total_spent_today', sa.Float(), nullable=False),
